...
export const startAddFund = (fund, portfolio) => {
    return (dispatch) => {
        // const fundData = require('../../static/funds.csv');
        // const newFund = fundData.find((fund) => fund.FundservCode === fundCode);
        // if (!newFund) {
        //     return undefined;
        // }
        ...
        const newFundMER = parseFloat(fund.fundMER);
        const newServiceFee = parseFloat(fund.serviceFee);
        const newFeeBase = 0;
